...
public class IHotelFlowDoAmendWSFaultFaultMessage extends Exception {
    ...
    public IHotelFlowDoAmendWSFaultFaultMessage(String message, WSFault wsFault) {
        super(message);
        this.wsFault = wsFault;
    }

    public IHotelFlowDoAmendWSFaultFaultMessage(String message, WSFault wsFault, Throwable cause) {
        super(message, cause);
        this.wsFault = wsFault;
    }
