...
public class ProductCollectionTask extends Task{
    ...
    public void init(){
       ...
       //destinationDOService = (DestinationDOService)ApplicationUtil.getBean("destinationService");
...
//        PageInfo<DestinationDO> destinationPageInfoPage = destinationDOService.pageQueryList(1,20);
//        Integer totalPage = destinationPageInfoPage.getPages();
//        for(int i=1; i<totalPage+1; i++){
//            PageInfo<DestinationDO> destinationPageInfo = destinationDOService.pageQueryList(i,20);
//            //根据destinationId, checkIn, checkOut 查询最新的酒店数据
//            for(DestinationDO destination : destinationPageInfo.getList()){
