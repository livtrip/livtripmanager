...
public class ProductCollectionTask extends Task{
    ...
    public void init(){
        ...
        destinationService = (DestinationService)ApplicationUtil.getBean("destinationService");
    ...
    public void execute(Map map) {
       ...
       //分页获取destinationIds
        ...
        PageInfo<Destination> destinationPageInfoPage = destinationService.pageQueryList(1,20);
        Integer totalPage = destinationPageInfoPage.getPages();
        for(int i=1; i<totalPage+1; i++){
            PageInfo<Destination> destinationPageInfo = destinationService.pageQueryList(i,20);
